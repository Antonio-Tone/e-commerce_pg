...
let dispProducts = document.querySelector('#Product.row');
Product.forEach((data) => {
    ...
    >
      ...
      <li ><img src="/icons/icon_bed_blue.svg" alt="bedrooms" >  Bedroom: 3</li>
          <li><img src="/icons/icon_bathroom_blue.svg">   Bathroom: 2</li>
          <li><img src="/icons/icon_secure_parking_blue.svg" alt="Parking ">  Parking: 1</li>
       </ol>
      </p>
      <br>
